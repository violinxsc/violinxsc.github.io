  ...
  function(module, exports, __webpack_require__) {
    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          //var minSrc = 'https://raw.githubusercontent.com/violinxsc/resources/master/min_img/' + data.link[i] ;
          //var src = 'https://raw.githubusercontent.com/violinxsc/resources/master/img/' + data.link[i];
		  var minSrc = 'https://photos-1256567675.cos.ap-beijing.myqcloud.com/min_img/' + data.link[i] ;
          var src = 'https://photos-1256567675.cos.ap-beijing.myqcloud.com/img/' + data.link[i];
    ...
    function loadData(success) {
      if (!searchData) {
        ...
        xhr.open('GET', '/js/data.json?t=' + +new Date(), true);
